...
app.get('/notes/:orderId/page/:pageNo/image', async (req, res) => {
  ...
  const processFiles = async () => {
    // Collect candidates from both single 'image' and multi 'images' fields for backward compatibility
    const uploadedFiles = [];
    if (req.files) {
      ...
      // multer sometimes exposes single-file as req.files.image (array) or req.file; also check req.file
